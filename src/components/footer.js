...
Footer.defaultProps = {
  ...
  Link: 'Stock Market',
  Link8: 'Partners',
  Link3: 'Maximise Profit',
  Link10: 'Press & Media',
  text1: 'Fcrit college vashi, Sector - 9A, Navi Mumbai - 400706',
  Header1: 'Company',
  pastedImage_src: '/playground_assets/footerlogo-200h.png',
  pastedImage_alt: 'pastedImage',
  Link7: 'News',
  Link2: 'Sell Stocks',
  Link5: 'About',
  text: '© 2023 chartwise. All Rights Reserved.',
  Header: 'Solutions',
  Link6: 'Team',
  Link4: 'Chart Pattern Analyzer',
}
